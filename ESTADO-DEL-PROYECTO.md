...
Última actualización / Last updated: 2026-07-12
...
6. **Portadas:** SVG en `assets/` (`poster-*.svg`). Se pueden crear con `tools/generador-portadas.html`. Se enlazan en `videos.json` con `"poster": "assets/xxx.svg"`.
