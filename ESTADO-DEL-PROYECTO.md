...
│       └── labs/                          (laboratorios/simuladores de práctica, sin calificar)
│           ├── index.html                    (hub de labs)
│           ├── optical-budget.html           (calculadora de presupuesto óptico — Módulo 2)
│           ├── otdr-reader.html              (lector de traza OTDR en canvas — Módulo 4)
│           └── connector-trainer.html        (flashcards de conectores/pulido/color — Módulo 1)
├── tools/
